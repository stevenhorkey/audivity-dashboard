                ...
                <div className="content">
                    <Row>
                        <Col xs={12}>
                            <Card>
                                <CardHeader>
                                    <h5 className="title"><i className='now-ui-icons loader_refresh spin mr-2'></i>Current Projects</h5>
                                </CardHeader>
                                {/* <CardBody>
                                    <form>
                                        <FormInputs
                            ...
                            <Card>
                                <CardHeader>
                                    <h5 className="title"><i className='now-ui-icons objects_spaceship mr-2'></i>Completed Projects</h5>
                                </CardHeader>
                            </Card>
                        </Col>
                    </Row>
